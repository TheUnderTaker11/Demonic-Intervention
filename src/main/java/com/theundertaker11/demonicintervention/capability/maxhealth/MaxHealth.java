...
public class MaxHealth implements IMaxHealth {
	 ...
	 */
	protected static final UUID MODIFIER_ID = UUID.fromString("2e1d9754-a566-40e5-bc2f-ad7a178ad64b");

	/**
	 * The name of the {@link AttributeModifier}.
	 */
	protected static final String MODIFIER_NAME = "Extra Max Health";
	...
	protected AttributeModifier createModifier() {
		return new AttributeModifier(MODIFIER_ID, MODIFIER_NAME, getBonusMaxHealth(), Reference.ATTRIBUTE_MODIFIER_OPERATION_ADD);
	}
